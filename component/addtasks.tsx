            ...
            <div className="bg-sky-100 dark:bg-gray-900 sm:w-[700px] sm:flex items-center flex-col
               rounded-2xl max-w-full w-full mx-1 my-4 sm:h-[700px] whitespace-nowrap justify-center">
                ...
                flex flex-wrap justify-center items-center">
                    ...
                    <div className="sm:flex  text-black font-serif text-sm sm:p-0 p-3 sm:text-md gap-2">
                        <span>Types :</span>
                        <select
                            name="type"
                            value={task.type}
                            onChange={handleChange}
                            id="seclectype"
                            className="bg-amber-200 sm:p-2 p-1.5  text-black rounded-md border-2 border-gray-500">
                        ...
                        <select
                            ...
                            onChange={handleChange}
                            id="priority"
                            className="bg-cyan-200 sm:p-2  text-black p-1.5 rounded-md border-2 border-gray-500 ">
