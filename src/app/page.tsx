  ...
  return (
    <div className="bg-white dark:bg-gray-900 dark:text-white transition-colors duration-300 ">
      <div className="min-h-screen border-0 border-amber-300  sm:py-4 sm:w-[95%px] flex flex-col lg:flex-row
        ...
        <div data-aos="fade-down-right" className="w-full max-w-xl flex flex-col gap-2 border-0 border-red-500">
          <h1 className=" dark:text-white text-2xl sm:text-4xl font-serif font-bold text-center textanimated">
            <p className=" text-2xl mb-10">Hi       <span className="text-5xl">{user?.email?.split('@')[0] || "Guest"}</span> </p>Welcome To TODOLIFE </h1>
