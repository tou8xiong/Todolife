        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl shadow-2xl border border-gray-700 p-8 sm:p-12">
          ...
          <div className="space-y-8 text-gray-300">
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3 mt-4">3.1 Account Creation</h3>
              <p className="mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3 mt-4">3.2 Account Security</h3>
              <p className="mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3 mt-4">3.3 Account Termination</h3>
              <p>
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3 mt-4">4.1 Your Content</h3>
              <p className="mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3 mt-4">4.2 Content Responsibility</h3>
              <p className="mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3 mt-4">4.3 Content Removal</h3>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">11. Data Backup</h2>
              <p>
